...
public final class RepositorioPostgreSqlPedido implements PedidoCommandRepository, PedidoQueryRepository {

    private final DataSource dataSource;

    public RepositorioPostgreSqlPedido(DataSource dataSource) {
